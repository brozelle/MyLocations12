...
// MARK: - Helper methods
    ...
    func region(for annotations: [MKAnnotation]) -> MKCoordinateRegion {
      ...
      //No annotations. Center the view on the users current location.
      case 0:
        region = MKCoordinateRegion(center: mapView.userLocation.coordinate,
                                    latitudinalMeters: 1000,
                                    longitudinalMeters: 1000)
    //One notation. Center on that.
      case 1:
        let annotation = annotations[annotations.count - 1]
        region = MKCoordinateRegion(center: annotation.coordinate,
                                    latitudinalMeters: 1000,
                                    longitudinalMeters: 1000)
    //two or more notations. Calculate the extent of their reach and add some padding.
      default:
...
extension MapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView,
      ...
      //Is the annotation really a Location object? If not, return nil.
      guard annotation is Location else {
        return nil
      }
      //If the map view cannot reuse an annotation view object, create a new one.
      let identifier = "Location"
      var annotationView = mapView.dequeueReusableAnnotationView(withIdentifier: identifier)
      if annotationView == nil {
        let pinView = MKPinAnnotationView(annotation: annotation,
                                          reuseIdentifier: identifier)
        //Sets properties to configure the look and feel of the annotation view.
        ...
        pinView.pinTintColor = UIColor(red: 0.32,
                                       ...
                                       blue: 0.4,
                                       alpha: 1)
        //Create a UIButton that looks like a detail disclosure button. Add the button to the view.
      ...
      if let annotationView = annotationView {
        ...
        //Sets the tag to the index of the Location object.
